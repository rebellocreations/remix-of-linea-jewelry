      ...
      <div className="flex">
        ...
        <main className="w-full lg:w-[70vw] lg:ml-auto px-6">
          <PageHeader
            ...
            subtitle="Creating beautiful pieces from recycled materials while protecting our planet"
          />
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16">
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  We partner only with suppliers who share our commitment to ethical practices. Every piece of glass and material in our collection is sourced responsibly, with full transparency in our supply chain.
                </p>
              </div>
              <div className="space-y-6">
                <h3 className="text-xl font-light text-foreground">Recycled Materials</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Over 80% of our materials come from recycled sources, reducing the environmental impact of waste while maintaining the highest quality standards for our lighting.
                </p>
              </div>
            </div>
          ...
          <ContentSection title="Circular Economy">
            <div className="space-y-8">
              <p className="text-lg text-muted-foreground leading-relaxed">
                We believe in the power of circular design - creating lighting that can be treasured, repaired, and eventually recycled into new pieces.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    When you're ready for something new, we'll take back your Rebello Creations piece to be recycled into future designs.
                  </p>
                </div>
              </div>
            </div>
