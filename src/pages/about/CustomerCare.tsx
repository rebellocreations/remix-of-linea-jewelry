    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        ...
        <main className="w-full lg:w-[70vw] lg:ml-auto px-6">
          <PageHeader
            title="Customer Care"
            subtitle="We're here to help you with all your lighting needs"
          />
          ...
          <ContentSection title="Contact Information">
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">care@rebellocreations.com</p>
          ...
          <ContentSection title="Frequently Asked Questions">
            <Accordion type="single" collapsible className="space-y-4">
              ...
              <AccordionItem value="warranty" className="border border-border rounded-lg px-6">
                ...
                <AccordionContent className="text-muted-foreground">
                  All Rebello Creations jewelry comes with a lifetime warranty against manufacturing defects. This includes free repairs for normal wear and tear, stone tightening, and professional cleaning.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="care" className="border border-border rounded-lg px-6">
                <AccordionTrigger className="text-left hover:no-underline">
                  How should I care for my Rebello Creations lighting?
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
              ...
              <AccordionItem value="authentication" className="border border-border rounded-lg px-6">
                ...
                <AccordionContent className="text-muted-foreground">
                  Every Rebello Creations piece comes with a certificate of authenticity and is hallmarked. You can verify authenticity on our website using your unique piece number or contact our customer care team.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </ContentSection>
