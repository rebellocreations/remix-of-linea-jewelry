        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-8">
          ...
          <div>
            <img
              ...
              className="mb-4 h-10 w-auto invert brightness-0"
            />
            <p className="text-sm font-light text-black/70 leading-relaxed max-w-md mb-6">
              Handcrafted lighting and home decor from recycled materials
            </p>
            ...
            <div className="space-y-2 text-sm font-light text-black/70">
              ...
              <div>
                ...
                <p>+1 (212) 555-0123</p>
                <p>hello@rebellocreations.com</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="https://www.instagram.com/rebello.creations/" target="_blank" rel="noopener noreferrer" className="text-sm font-light text-black/70 hover:text-black transition-colors">Instagram</a></li>
      ...
      <div className="border-t border-[#e5e5e5] -mx-6 px-6 pt-2">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm font-light text-black mb-1 md:mb-0">
            © {new Date().getFullYear()} Rebello Creations. All rights reserved.
          </p>
