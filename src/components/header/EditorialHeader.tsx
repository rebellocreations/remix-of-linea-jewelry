        ...
        <nav className="flex items-center justify-between h-20 px-6 lg:px-12">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              {customer && (
                <span className="absolute top-1 right-1 w-2 h-2 bg-olive rounded-full" />
              )}
            </button>
            <CartDrawer />
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden bg-background border-t border-border animate-fade-up">
            <div className="px-6 py-8 space-y-6">
              ...
              <button
                className="block font-serif text-2xl text-foreground hover:text-olive transition-colors duration-300 w-full text-left"
                onClick={() => {
