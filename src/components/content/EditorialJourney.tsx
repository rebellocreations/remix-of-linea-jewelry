...
const EditorialJourney = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-24 md:py-32 bg-[#F9F6F0] overflow-hidden"
    >
      ...
      <div className="container relative z-10 px-4 md:px-6 mx-auto">
        {/* Header Section */}
        <div className={cn(
          "text-center mb-12 md:mb-16 transition-all duration-700 ease-editorial",
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif text-charcoal tracking-tight relative inline-block">
            From <span className="font-semibold">Bottle</span> to Glow
            {/* Vertical line connecting title to card */}
            <div className={cn(
              "absolute left-1/2 -bottom-16 w-[1px] h-16 bg-amber-900/20 -translate-x-1/2 hidden md:block transition-all duration-1000 delay-300",
        ...
        <div className={cn(
          "relative bg-white/40 backdrop-blur-sm rounded-[3rem] p-8 md:p-12 lg:p-16 border border-white/50 shadow-[0_8px_32px_rgba(0,0,0,0.02)] transition-all duration-1000 delay-200",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 relative items-start">
            ...
            {steps.map((step, index) => (
              <div
                key={index}
                className={cn(
                  "group flex flex-col items-center text-center relative z-10",
                  step.delay
                )}
              >
                {/* Image Container */}
                ...
                <div className="space-y-3 max-w-[260px]">
                  <h3 className="text-2xl font-serif text-charcoal/90">{step.title}</h3>
                  <div className="w-8 h-[1px] bg-amber-900/10 mx-auto my-3" />
